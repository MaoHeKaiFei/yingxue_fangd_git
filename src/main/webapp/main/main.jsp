...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><button id="showUser" class="btn btn-info" >
                                        <%--点击重新加载一个页面--%>
                                        <a href="javascript:$('#rightShow').load('${path}/user/user.jsp')">用户展示</a>
                                    </button><br><br></li>
                                    <li><button class="btn btn-info" >
                                        <a href="javascript:$('#rightShow').load('${path}/user/userStat.jsp')"> 用户统计</a>
                                       </button><br><br></li>
                                    <li><button class="btn btn-info" >
                                        <a href="javascript:$('#rightShow').load('${path}/user/userDistribute.jsp')">   用户分布</a>
                                      </button><br><br></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><button class="btn btn-success" >
                                        <a href="javascript:$('#rightShow').load('${path}/category/category.jsp')">分类展示</a>
                                    </button><br><br></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><button class="btn btn-warning" >
                                        <a href="javascript:$('#rightShow').load('${path}/video/video.jsp')">视频展示</a>
                                    </button><br><br></li>

                                    <li><button class="btn btn-info" >
                                        <a href="javascript:$('#rightShow').load('${path}/video/search.jsp')">视频搜索</a>
                                    </button><br><br></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><button class="btn btn-danger" >
                                        <a href="javascript:$('#rightShow').load('${path}/log/log.jsp')">日志展示</a>
                                    </button><br><br></li>
                                </ul>
                            </div>
                        </div>
            ...
            <!--右边部分-->
            <div class="col-md-10" id="rightShow">
                <!--巨幕开始-->
                <div class="jumbotron">
